...
def display_initial_risk_assessment():
    ...
    bmi = col1.number_input("BMI (kg/qm)", value = 25)
    age = col2.number_input("Age (years)", value = 20)
    ...
    glucose_min = col1.number_input("Glucose (mmol/L)", value = 4)
    lactate_max = col2.number_input("Lactate (mmol/L)", value = 2)
    sysbp_min = col1.number_input("Systolic Blood Pressure (mmHg)", value = 130)
    mpb_min = col2.number_input("Mean Arterial Pressure (mmHg)", value = 90)
    hr_max = col1.number_input("Heart Rate (bpm/min)", value = 100)
    temp_min = col2.number_input("Temperature (°C)", value = 40)
    rr_min = col1.number_input("Respiratory Rate (breaths/min)", value = 17)
    spo2_max = col2.number_input("SpO2 (%)", value = 99)
...
def display_advanced_risk_assessment():
    ...
    hr_max = col2.number_input("Maximal Heart Rate (bpm/min)", value = 120)
    hr_min = col1.number_input("Minimal Heart Rate (bpm/min)", value = 30)
    sysbp_max = col2.number_input("Maximal Systolic Blood Pressure (mmHg)", value = 130)
    sysbp_min = col1.number_input("Minimal Systolic Blood Pressure (mmHg)", value = 81)
    rr_max = col2.number_input("Maximal Respiratory Rate (breaths/min)", value = 20)
    rr_min = col1.number_input("Minimal Respiratory Rate (breaths/min)", value = 14)
    mbp_min = col1.number_input("Minimal Mean Arterial Pressure (mmHg)", value = 90)
    hco3_max = col2.number_input("Maximal Bicarbonate (mmol/L)", value = 32)
    glucose_min = col1.number_input("Minimal Glucose (mmol/L)", value = 3)
    sodium_min = col2.number_input("Minimal Sodium (mmol/L)", value = 136)
    wbc_min = col1.number_input("Minimal White Blood Cell Count (10^9/L)", value = 4)
    wbc_max = col2.number_input("Maximal White Blood Cell Count (10^9/L)", value = 10)
    bun_max = col1.number_input("BUN (mmol/L)", value = 9)
    crea_max = col2.number_input("Creatinine (mmol/L)", value = 100)
    platelets_min = col1.number_input("Minimal Platelets (10^9/L)", value = 100)
    hema_min = col2.number_input("Minimal Hemaglobin (g/dL)", value = 10)
    ...
    spo2_min = st.number_input("Minimal SpO2 (%)", value =99)
    icu_admit = st.selectbox("Patient Admitted from the Emergency Room?", ["yes", "no"])
